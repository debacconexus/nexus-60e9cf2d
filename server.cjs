...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Child Protection Case Management System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Child Protection Case";
process.env.TABLE_NAME = process.env.TABLE_NAME || "child_protection_case_records";
'use strict';
